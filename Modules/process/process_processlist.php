...
class Process_ProcessList
{
    ...
    public function core_process_list()
    {
        ...
        $list[15] = array(_("Rate of change"),ProcessArg::FEEDID,"ratechange",1,DataType::REALTIME,"Misc",array(Engine::PHPFIWA,Engine::PHPSUM,Engine::PHPAVE,Engine::PHPFINA,Engine::PHPTIMESERIES), 'requireredis'=>true, 'desc'=>"Output feed is the difference between the current value and the last");
        ...
        $list[18] = array(_("Heat flux"),ProcessArg::FEEDID,"heat_flux",1,DataType::REALTIME,"Deleted",array(Engine::PHPFIWA,Engine::PHPSUM,Engine::PHPAVE,Engine::PHPFINA,Engine::PHPTIMESERIES), 'desc'=>"");
        ...
        $list[21] = array(_("kWh to Power"),ProcessArg::FEEDID,"kwh_to_power",1,DataType::REALTIME,"Power",array(Engine::PHPFIWA,Engine::PHPSUM,Engine::PHPFINA,Engine::PHPAVE,Engine::PHPTIMESERIES), 'requireredis'=>true, 'desc'=>"Convert accumulating kWh to instantaneous power");
